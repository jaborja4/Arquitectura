<%-- 
    Document   : anuncios
    Created on : 28/05/2018, 11:02:36 PM
    Author     : Jose Achig
--%>
<%@page import="Servlet.SvrPlantilla"%>
<!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <body>
        <jsp:useBean id="Auv_Anuncio" scope="request" class="Modelo.Auv_Anuncio"/>
        <div class="container">
                    ...
                    <div class="page-container">
                        ...
                        <div class="page-sidebar">
                            ...
                            <ul id="side-nav" class="main-menu navbar-collapse collapse">
                                <li ><a href="gestion_usuario.jsp"><i class=" icon-graduation-cap"></i><span class="title">Gestionar usuarios</span></a>
                                ...
                                <li class="active"><a href="anuncios.jsp"><i class=" icon-publish"></i><span class="title">Anuncios</span></a>
                                <li ><a href="plantilla.jsp"><i class=" icon-archive"></i><span class="title">Plantilla</span></a>
                        ...
                        <div class="card-body pad table-responsive">
                            ...
                            <table class="table table-bordered text-center">
                                <tr>
                                    <th><h2><center>Campo</center></h2></th>
                                    <th><h2><center>Caracteristica</center></h2></th>

                                </tr>
                                <tr>
                                    <td>
                                        <h4> <b>Código Anuncio</b> </h4>
                                    </td>
                                    <td>
                                        <!-- /.card-header -->
                                        <div class="card-body">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select2" style="width: 100%;">
                                                            <option selected="selected">Datos quemados</option>
                            ...
                            <td>
                                <div class="col-md-3 ">
                                    ...
                                    <button type="button" class="linea btn btn-block btn-primary btn-lg ">Crear</button>
                                 <button type="button" class="linea btn btn-block btn-primary btn-lg" >Modificar</button>
                                <button type="button" class="linea btn btn-block btn-primary btn-lg">Eliminar</button>
