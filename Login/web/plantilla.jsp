...
<html lang="en">
    ...
    <body>
        <jsp:useBean id="Auv_Entrega_Tarea" scope="request" class="Modelo.Auv_Entrega_Tarea"/>
        <div class="container">
                    ...
                    <div class="page-container">
                        ...
                        <div class="page-sidebar">
                            ...
                            <ul id="side-nav" class="main-menu navbar-collapse collapse">
                                ...
                                <li class="active"><a href="plantilla.jsp"><i class=" icon-archive"></i><span class="title">Plantilla</span></a>
                        ...
                        <div class="card-body pad table-responsive">
                            <center><h1>Plantilla personalizada</h1></center>
                            <table class="table table-bordered text-center">
                                ...
                                <tr>
                                    <td>
                                        <h4> <b>Caificacion de Tarea</b> </h4>
                                    </td>
                                    <td>
                                        <!-- /.card-header -->
                                        <div class="card-body">
                            ...
                            <td>
                                <button type="button" class="btn btn-block btn-primary btn-lg">Enviar</button>
                            </td>
