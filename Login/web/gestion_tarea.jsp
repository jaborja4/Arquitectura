		...
		<div class="col-lg-12">
			...
			<form class="form-inline">
				<div class="form-group">
					...
					<input type="text" id="filterusers" placeholder="B̼squeda por ID, nombre, c̩dula o correo." class="form-control" size="100px">
				</div>
				<!--<div class="form-group">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="SvrTarea" role="form" method="POST">
           <div class="form-group">
           <label for="tema">Tema</label>
           <input type="tex" class="form-control" id="tema" name="tema">
           </div>
           <div class="form-group">
